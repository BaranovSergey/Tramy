...
const UserProfile = () => {
    ...
    return (
        <Box sx={{ marginTop: 4, marginRight: 6 }}>
            ...
            <UpdList sx={{ width: '100%', maxWidth: 360 }}>
                <ListItem>
                    <ListItemAvatar>
                        <Avatar
                            sx={{ width: 200, height: 200, borderRadius: 10, marginLeft: '5%' }}
                            src="https://sun9-69.userapi.com/impf/Mz685ma3ZPU6qCUCfR-HG-FeJi2f45gSWGqFmQ/3Xbe_hGAj9Q.jpg?size=1215x2160&quality=96&sign=0ccc4ac3b1e77db54d2d386491c0ae49&type=album"
                        />
                    </ListItemAvatar>
                </ListItem>
                <ListItem>
